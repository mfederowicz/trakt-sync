...
func TestModuleFlagUpdaters(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "shows report", cmd: ShowsCmd, args: []string{"-a", "report", "-i", "the-sopranos", "-r", "metadata", "-message", "wrong overview"}, path: func(string) string { return "/shows/the-sopranos/report" }},
		{name: "shows report default reason is rejected", cmd: ShowsCmd, args: []string{"-a", "report", "-i", "the-sopranos"}, path: func(string) string { return "" }},
		{name: "shows sentiments", cmd: ShowsCmd, args: []string{"-a", "sentiments", "-i", "the-sopranos"}, path: func(string) string { return "/shows/the-sopranos/sentiments" }},
		...
		{name: "seasons report by trakt id (-i without -season)", cmd: SeasonsCmd, args: []string{"-a", "report", "-i", "3950", "-r", "metadata"}, path: func(string) string { return "/seasons/3950/report" }},
		...
		{name: "episodes report by trakt id (-i without -season/-episode)", cmd: EpisodesCmd, args: []string{"-a", "report", "-i", "73482", "-r", "runtime"}, path: func(string) string { return "/episodes/73482/report" }},
		{name: "episodes report with only -episode is rejected", cmd: EpisodesCmd, args: []string{"-a", "report", "-i", "the-sopranos", "-episode", "2", "-r", "runtime"}, path: func(string) string { return "" }},
		{name: "episodes report with only -season is rejected", cmd: EpisodesCmd, args: []string{"-a", "report", "-i", "the-sopranos", "-season", "1", "-r", "runtime"}, path: func(string) string { return "" }},
		...
		{name: "episodes watchnow by trakt id (-i without -season/-episode)", cmd: EpisodesCmd, args: []string{"-a", "watchnow", "-i", "73482", "-country", "us"}, path: func(string) string { return "/episodes/73482/watchnow/us" }},
		{name: "episodes watchnow with only -season is rejected", cmd: EpisodesCmd, args: []string{"-a", "watchnow", "-i", "the-sopranos", "-season", "1", "-country", "us"}, path: func(string) string { return "" }},
