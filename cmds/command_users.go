...
func usersListsFunc(cmd *Command, _ ...string) error {
	...
	allHandlers := map[string]handlers.Handler{
		...
		consts.SmartLists:         handlers.UsersSmartListsHandler{},
		consts.SmartList:          handlers.UsersSmartListHandler{},
		consts.AddSmartList:       handlers.UsersAddSmartListHandler{},
		consts.UpdateSmartList:    handlers.UsersUpdateSmartListHandler{},
		consts.DeleteSmartList:    handlers.UsersDeleteSmartListHandler{},
		consts.CommentReactions:   handlers.UsersCommentReactionsHandler{},
		consts.Activities:         handlers.UsersActivitiesHandler{},
		consts.MonthInReview:      handlers.UsersMonthInReviewHandler{},
		consts.YearInReview:       handlers.UsersYearInReviewHandler{},
		...
		consts.PlexSettings:       handlers.UsersPlexSettingsHandler{},
		consts.UpdatePlexSettings: handlers.UsersUpdatePlexSettingsHandler{},
		consts.PlexConnect:        handlers.UsersPlexConnectHandler{},
		consts.PlexDisconnect:     handlers.UsersPlexDisconnectHandler{},
		consts.PlexServers:        handlers.UsersPlexServersHandler{},
		consts.PlexServer:         handlers.UsersPlexServerHandler{},
		consts.PlexSync:           handlers.UsersPlexSyncHandler{},
	}
	...
	validActions = []string{"settings", "following_requests", "follower_requests",
		...
		consts.DataSync, consts.DataSyncPaused, consts.DataSyncSkipped, consts.UndoDataSync, consts.PlexSettings,
