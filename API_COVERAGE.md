...
| ⬜ | GET | `/search/{type}/exact` | Get exact text query results |  |
...
| ⬜ | POST | `/shows/{id}/seasons/{season}/episodes/{episode}/report` | Report an episode |  |
...
| ⬜ | POST | `/shows/{id}/seasons/{season}/report` | Report a season |  |
...
| ⬜ | GET | `/sync/playback/episodes` | Get episode playback progress |  |
| ⬜ | GET | `/sync/playback/movies` | Get movie playback progress |  |
