...
func (m EpisodesPeopleHandler) Handle(options *str.Options, client *internal.Client) error {
	printer.Println("Returns all people related with season.")
	if len(options.InternalID) == consts.ZeroValue {
		return errors.New(consts.EmptyInternalIDMsg)
	}

	result, _, err := m.fetchEpisodesPeople(client, options)
...
func (EpisodesPeopleHandler) fetchEpisodesPeople(client *internal.Client, options *str.Options) (*str.EpisodePeople, *str.Response, error) {
